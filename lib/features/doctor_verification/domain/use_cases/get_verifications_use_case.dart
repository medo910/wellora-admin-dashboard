// lib/features/doctor_verification/domain/use_cases/get_verifications_use_case.dart
...
//   Future<Either<Failure, List<DoctorVerificationEntity>>> call({
//     int page = 1,
//     int pageSize = 10,
//     String? status,
//     String? fromDate,
...
class GetVerificationsUseCase {
  ...
  // التعديل هنا في الـ return type
